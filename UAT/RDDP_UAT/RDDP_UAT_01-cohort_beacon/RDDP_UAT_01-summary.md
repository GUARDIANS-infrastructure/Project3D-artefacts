...
2. The field `response.organization.name` is currently "Garvan Institute for Medical Research" while it should be "Garvan Institute **of** Medical Research" (note that the description is correct). Issue reported [#4](https://github.com/Garvan-Data-Science-Platform/beacon2-pi-api/issues/4)
